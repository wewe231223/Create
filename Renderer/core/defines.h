...
// bool 스프라이트를 활성화 했는지 
// uint 가로 이미지 개수 
// uint 이미지의 가로 단위 길이 ( 이미지 총 가로 길이 / 가로 이미지 개수 ) 
// uint 세로 이미지 개수 
// uint 이미지의 세로 단위 길이 ( 이미지 총 세로 길이 / 세로 이미지 개수 ) 
// float 0번째부터 n 번째 까지 걸리는 시간 
// 
...
// UV 변환 행렬은 다음과 같다 
// 
// float 이미지 가로 계수 = 1.0 / 이미지 가로 개수 
// float 이미지 세로 계수 = 1.0 / 이미지 세로 계수 
// 
...
// -----------------------------------------------------------------------------------------------------------------------
// |		이미지 가로 계수			|				0.0					|		이미지 가로 계수 * 스프라이트 가로 좌표		|	
// -----------------------------------------------------------------------------------------------------------------------
// |			0.0					|			이미지 가로 계수			|		이미지 세로 계수 * 스프라이트 세로 좌표		|
// -----------------------------------------------------------------------------------------------------------------------
// |			0.0					|				0.0					|					1.0							|
// -----------------------------------------------------------------------------------------------------------------------
// 
...
#pragma region Sprite 
	...
	UINT spriteUnitWidth{ 0 };
	UINT spriteFrameInCol{ 0 };
	UINT spriteUnitHeight{ 0 };
	float spriteDuration{ 0.f };
